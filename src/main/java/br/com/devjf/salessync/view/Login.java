...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mainPanel.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(225, 229, 235), 2, true));
        ...
        loginField.getAccessibleContext().setAccessibleDescription("Login");
