...
/**
 * Controller class for managing customer-related operations. Provides methods
 * for creating, updating, deleting, and retrieving customer information.
 */
public class CustomerController {
    ...
    public List<Customer> findWithPagination(int page, int pageSize) {
        return customerService.listCustomersWithPagination(page,
                pageSize);
    }
     ...
     * @return A string with validation errors or null if the customer was
     ...
     * @return A formatted string with customer name and tax ID, or empty if
     * customer not found
     */
    ...
    public Customer getCustomerForSale(Integer customerId) {
        ...
        try {
            ...
            System.err.println(
                    "Error getting customer for sale: " + e.getMessage());
            return null;
        }
    }
}
