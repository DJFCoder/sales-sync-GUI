...
public class TableUtil {
    ...
    private static final DateTimeFormatter DEFAULT_DATE_ONLY_FORMATTER = DateTimeFormatter.ofPattern("dd/MM/yyyy");
    ...
    /**
     * Configura um TableRowSorter para a tabela e adiciona filtros dinâmicos baseados nos campos de texto.
     * 
    ...
    public static <T extends DefaultTableModel> TableRowSorter<T> setupTableFilter(
        ...
        if (textFields.length != columnIndexes.length) {
            throw new IllegalArgumentException("O número de campos de texto deve ser igual ao número de índices de coluna");
        }
        ...
        for (int i = 0; i < textFields.length; i++) {
            final JTextField textField = textFields[i];
            ...
            textField.getDocument().addDocumentListener(new DocumentListener() {
                ...
                private void updateFilter() {
                    applyFilters(sorter, textFields, columnIndexes);
                }
            });
        }
    ...
    public static String formatCurrency(Double value) {
        return value != null ? String.format("R$ %.2f", value) : "";
    }
